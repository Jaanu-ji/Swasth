            ...
            >
              <View style={styles.headerCardContent}>
                <View style={styles.headerIconBg}>
                  <MaterialCommunityIcons name="lightbulb" size={24} color={figmaTokens.colors.white} />
                </View>
                      ...
                      <FigmaCard key={index} style={styles.insightCard}>
                        <View style={styles.insightContent}>
                          <View style={[styles.insightIconBg, { backgroundColor: insight.color || getColorForCategory(insight.category) }]}>
                            <MaterialCommunityIcons name={insight.icon || getIconForCategory(insight.category)} size={24} color={figmaTokens.colors.white} />
                          </View>
                        ...
                        <FigmaCard key={index} style={styles.goalCard}>
                          <View style={styles.goalContent}>
                            <View style={styles.goalIconBg}>
                              <MaterialCommunityIcons name={goal.icon || 'target'} size={20} color={figmaTokens.colors.blue600} />
                            </View>
                        ...
                        {personalizedTips.map((tip, index) => (
                          <View key={index} style={styles.tipItem}>
                            <View style={styles.tipIcon}>
                              <MaterialCommunityIcons name="lightbulb-outline" size={16} color={figmaTokens.colors.purple600} />
                            </View>
