...
import { chat, fetchChatHistory, saveChat } from '../../config/api';
...
export default function ChatScreen() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      await saveChat(user.email, messageText, aiReply);
    } catch (error) {
          ...
          <View style={styles.inputContainer}>
            ...
            >
              {loading ? (
                ...
                <MaterialCommunityIcons name="send" size={20} color={figmaTokens.colors.white} />
              )}
            </TouchableOpacity>
          </View>
        </KeyboardAvoidingView>
